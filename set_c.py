...
"""
5.12 Start up a Python session and use 'requests.get' to read the source
...
HTML tag that looks like
	 ...
	 <a href='http://my.computer.com/somefile.html'>link text <a>

The link is everything in quotes after the href=, and the text is
everything between the > and the </a>.
"""
